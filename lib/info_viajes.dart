...
class _InfoViajesState extends State<InfoViajes> {
  ...
  bool _isConductorEnabled =
      false; // Controla el estado del switch "Conductor" o "Pasajero"
  ...
  void _showPasajeroPopup(
    BuildContext context,
    Map<String, dynamic> pasajero,
    TextStyle greenTextStyle,
    TextStyle buttonTextStyle,
  ) {
    final fotoPerfil = pasajero['foto_perfil']?.toString();
    final fotoValida = fotoPerfil != null && fotoPerfil.isNotEmpty;
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
